    ...
    async function exportAsHTML(sortedSecrets, options = {}) {
      ...
      try {
        ...
        htmlParts.push('      </tbody>\\n' +
          '    </table>\\n' +
          '    <div class="footer">\\n' +
          '      Generated by <a href="https://github.com/vfhky" target="_blank" style="color: #4a90d9; text-decoration: none;">vfhky</a> | ' +
          '      <a href="https://github.com/vfhky/2fa" target="_blank" style="color: #4a90d9; text-decoration: none;">2FA</a> | ' +
